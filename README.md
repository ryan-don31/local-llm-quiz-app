...
This app uses a local Ollama model to generate quizzes based off an uploaded PDF. There are safety measures for prompt injections, there is some testing for the responses, and logging for the requests.
